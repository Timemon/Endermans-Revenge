// to prevent issues with dedicated servers these are in a different file 
...
//Hides from NEI Anti-teleportation
	...
	//reliquary
		NEI.hide(<xreliquary:ender_staff>);
	...
	//blood magic
		NEI.hide(<AWWayofTime:blockTeleposer>);
		
	//pneumaticCraft
		NEI.hide(<PneumaticCraft:aerialInterface>);
		
	//gany's end
		NEI.hide(<ganysend:inventoryBinder>);
		NEI.hide(<ganysend:blockShifter>);
		NEI.hide(<ganysend:entityShifter>);
